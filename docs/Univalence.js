...
var cyclic = Data_Functor.mapFlipped(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(FRP_Behavior_Time.seconds)((function () {
    var $45 = Data_Newtype.unwrap(Data_Time_Duration.newtypeSeconds);
    return function ($46) {
        return (function (t) {
...
var main = function __do() {
    var v = Web_HTML.window();
    var v1 = Data_Functor.mapFlipped(Effect.functorEffect)(Web_HTML_Window.document(v))(Web_HTML_HTMLDocument.toNonElementParentNode)();
    var get = function (i) {
        return Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromJust())(Web_DOM_NonElementParentNode.getElementById(i)(v1));
    };
    var v2 = get("lower")();
    var v3 = get("mid")();
    var v4 = get("curved")();
    var render = function (scene) {
        ...
        return function __do() {
            ...
            set(scene.mid)(v3)();
            set(scene.curved)(v4)();
            return Web_DOM_Element.setAttribute("transform")(scene.rot)(v4)();
        };
    };
    var renderAt = function ($47) {
        return render(infos(pos($47)));
    };
    var v5 = FRP_Behavior.animate(cyclic)(renderAt)();
    var astep = 1.0 / 8.0;
    var v6 = Effect_Ref["new"](-1.0 * astep)();
    var v7 = Web_Event_EventTarget.eventListener(function (v7) {
        return function __do() {
            var v8 = Effect_Ref.read(v6)();
            Control_Applicative.when(Effect.applicativeEffect)(v8 < 0.0)(v5)();
            Effect_Ref.modify_(function ($48) {
                return (function (v9) {
                    return $$Math.remainder(v9)(rollover);
                })((function (v9) {
                    return v9 + astep;
                })($48));
            })(v6)();
            var v9 = Effect_Ref.read(v6)();
            return renderAt(v9)();
        };
    })();
    var v8 = Web_Event_EventTarget.eventListener(function (v8) {
        var forFrame = function (frame) {
            return infos(pos(frame / 8.0));
        };
        return function __do() {
            var v9 = $foreign.mkZip();
            Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Array.range(0)(44))(function (frame) {
                ...
                var svg = "\x0a          <svg>\x0a            <g id=\"layer1\" style=\"fill:none;stroke:#000000;stroke-width:8;stroke-linecap:butt;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:" + (Data_Show.show(Data_Show.showNumber)(0.25) + (">\x0a            " + (allpaths + ("\x0a            </g>\x0a            <g id=\"layer2\" style=\"fill:none;stroke:#ffffff;stroke-width:20;stroke-linecap:square;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:" + (Data_Show.show(Data_Show.showNumber)(0.25) + (">\x0a            " + (allpaths + "\x0a            </g>\x0a          </svg>\x0a          ")))))));
                return function __do() {
                    var v10 = Control_Bind.bindFlipped(Effect.bindEffect)((function () {
                        var $49 = Web_DOM_Document.createElement("canvas");
                        return function ($50) {
                            return $49(Web_HTML_HTMLDocument.toDocument($50));
                        };
                    })())(Web_HTML_Window.document(v))();
                    Web_DOM_Element.setAttribute("width")("128")(v10)();
                    Web_DOM_Element.setAttribute("height")("128")(v10)();
                    var v11 = Control_Bind.bindFlipped(Effect.bindEffect)((function () {
                        var $51 = Web_DOM_Node.appendChild(Web_DOM_Element.toNode(v10));
                        var $52 = Data_Maybe.fromJust();
                        return function ($53) {
                            return $51(Web_HTML_HTMLElement.toNode($52($53)));
                        };
                    })())(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_HTMLDocument.body)(Web_HTML_Window.document(v)))();
                    $foreign.canvg(v10, svg);
                    return $foreign.saveCanvas(v10, "frame" + Data_Show.show(Data_Show.showInt)(frame), v9);
                };
            })();
            return $foreign.saveZip(v9);
        };
    })();
    Web_Event_EventTarget.addEventListener("click")(v7)(false)(v)();
    Web_Event_EventTarget.addEventListener("dblclick")(v8)(false)(v)();
    return Data_Unit.unit;
};
module.exports = {
    curve: curve,
